    ...
    <header class="head">
        ...
        ?>
           ...
           <div class="section-container p-2 p-xl-4">
                ...
                <h4 class="fs-6 fw-bolder my-3 mt-2 mb-4">liste Objets de l'Utilisateur</h4>
                    ...
                    ?>
                            <div class="col-md-4 mb-3">
                                <div class="app-cover p-2 shadow-md bg-white">
                                    <div class="row">
                                        <div class="img-cover pe-0 col-3"> <img class="rounded" src=<?php echo site_url($obj["pathImage"]); ?> width="500px" height="100px" alt=""></div>
                                        <div class="det mt-2 col-9" style="float: right;">
                                            <h4 class="mb-0 fs-6"><?php echo $obj["nomObjet"]; ?></h4>
                                            <br>
                                            <span class="mb-0 fs-6 btn button-objet"><a href=<?php echo site_url("loader/listes_objets_a_echanger/".$obj["idObjet"]); ?>>Echanger</a></span>
                                            <span class="mb-0 fs-6 btn button-objet"><a href=<?php echo site_url("loader/apercu_autre/".$obj["idObjet"]."/".$idUser); ?>>Aperçue</a></span>
